...
public class OrderReport {
	...
	public OrderReport(int orderId, int custID, float total, String orderDate, int employID) {
		setOrderID(orderId);
	...
	public String toString() {
		if(getCustomerID() != 0)
			...
			return "Order:" + getOrderID() + "   Total:" + getTotal() + "    OrderDate:" + getOrderDate() + "    Employee:" + Program.getInstance().getDataAccess().getEmployeeById(getEmployeeID()).getName();
	}
